    ...
    return (
        <Box sx={{ textAlign: 'center', margin: '40px' }}>
            ...
            <div>
                ...
                {/* <Typography variant="body1">{LOCALES[locale].LOCATION.ISTANBUL.LOCAL_TRANSPORTATION}</Typography>
                <Typography variant="body1">{LOCALES[locale].LOCATION.ISTANBUL.CHECK_TRAVEL_INFO}</Typography> */}
            </div>
